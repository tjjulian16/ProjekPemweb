...
<div class="row">
  <div class="col-lg-4 col-sm-12">
    <div class="card">
      <img src="assets/kelola.png" >
      <div class="card-body" >
        <a href="kelolaAdmin.php" class="btn btn-lg btn-primary">Kelola Pengiriman</a>
        <br><br>
  ...
  <div class="col-lg-4 col-sm-12">
    <div class="card">
      <img src="assets/riwayat.png">
      <div class="card-body" >
        <a href="historyAdmin.php" class="btn btn-lg btn-primary">Riwayat Pengiriman</a>
        <br><br>
  ...
  <div class="col-lg-4 col-sm-12">
    <div class="card">
      <img src="assets/kurir.png" >
      <div class="card-body" >
        <a href="listKurir.php" class="btn btn-lg btn-primary">List Kurir</a>
        <br><br>
